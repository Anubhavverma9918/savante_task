...
import HeroImg from '../../images/influencer.avif';
    ...
    <div id='influencer'>
      ...
      <Modal isOpen={visible} onRequestClose={() => setvisible(false)} style={{
                ...
                <h1 style={{color: "white",marginBottom:"20px", fontFamily:"poppins", fontSize:"30px", fontWeight:"bold", width:"250px", marginLeft:"25px"}}>BRAND SIGNUP</h1>
                        ...
                        <a href='#' onClick={() => setvisibly(true)} style={{color: "white",marginBottom:"20px", fontFamily:"poppins",cursor:"pointer", fontSize:"15px", fontWeight:"bold", width:"250px", marginLeft:"55px"}}>Influencer? SignUp here!</a>
      ...
      <Modal isOpen={visibly} onRequestClose={() => setvisibly(false)} style={{
       ...
       <HeroContainer>
          ...
          <HeroInnerContainer>
              <HeroLeftContainer>
                    <Title>Who is a <br/>Influencer?</Title>
                    <SubTitle>"You are! If you have a social presence of any kind where people follow you, you automatically yield the power to influence them. The impact varies by the reach & popularity, but the power to influence exists. On Savante, all kinds of influencers are welcome & sought after by brands - from celebs to popular social media stars to everyday passionate consumers. Even if you are new to influencing, just sign up and our algorithm will help you know your SMV (Social Media Value). Feel free to enter your fee though, and reach out to us for any help."</SubTitle>
                    <ResumeButton onClick={() => setvisibly(true)} target="display">Get Started</ResumeButton>
              </HeroLeftContainer>
              <HeroRightContainer>
